...
class DictionaryCTC:
    ...
    def __init__(
        ...
        # print("blank_in_dic:", self.blank_index)
        # exit()
    ...
    def string(
        ...
        # print("tensor_in_string:", tensor.shape)
        # print(tensor)
    ...
    def add_file_to_dictionary(filename, dict, tokenize, num_workers):
        ...
        if num_workers > 1:
            ...
            for worker_id in range(num_workers):
                results.append(
                    pool.apply_async(
                        DictionaryCTC._add_file_to_dictionary_single_worker,
...
class TruncatedCTCDictionary(object):
