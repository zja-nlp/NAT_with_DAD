...
@register_model("vanilla_nat")
class VanillaModel(FairseqNATModel):
    @property
    ...
    def add_args(parser):
        ...
        parser.add_argument(
            "--input-transform",
            action="store_true",
            help="whether to use the input transformation method",
        )
    ...
    def forward(
            self, src_tokens, src_lengths, prev_output_tokens, tgt_tokens, glat=None, at_prev_output_tokens=None,
            **kwargs
    ):
...
class VanillaDecoder(FairseqNATDecoder):
