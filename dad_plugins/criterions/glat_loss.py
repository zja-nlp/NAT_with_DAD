...
class LabelSmoothedDualImitationCriterion(FairseqCriterion):
    ...
    def _compute_loss(
        ...
        if masks is not None:
            ...
            # print("outputs_after_mask:", outputs.shape)
            # print(outputs)
            # print("targets_after_mask:", targets.shape)
            # print(targets)
            # exit()
    ...
    def forward(self, model, sample, reduce=True):
        ...
        outputs = model(src_tokens, src_lengths, prev_output_tokens, tgt_tokens, glat, at_prev_output_tokens=at_prev_output_tokens)

        # finetune coverage
        # outputs, coverage_loss = model(src_tokens, src_lengths, prev_output_tokens, tgt_tokens, glat)
        losses, nll_loss = [], []
        ...
        # logging_output = {
        #     "loss": loss.data,
        #     "coverage_loss": coverage_loss.data,
        #     "nll_loss": nll_loss.data,
        #     "ntokens": ntokens,
        #     "nsentences": nsentences,
        #     "sample_size": sample_size,
    ...
    def reduce_metrics(logging_outputs) -> None:
        ...
        # finetune coverage
        # coverage_loss = utils.item(sum(log.get("coverage_loss", 0) for log in logging_outputs))
