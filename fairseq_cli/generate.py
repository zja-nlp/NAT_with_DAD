        ...
        for i, sample_id in enumerate(sample["id"].tolist()):
            ...
            if align_dict is not None:
                ...
                if src_dict is not None:
                    # print("post_process:", cfg.common_eval.post_process)
                    # exit()
                    # print("src_dict:", src_dict)
                    # print("src_tokens:", src_tokens.shape)
                    # src_str = src_dict.string(src_tokens[1:-1]-1, cfg.common_eval.post_process)
                ...
                if has_target:
                    ...
                    # )
            # exit()
            # print("src_str1:",src_str)
            src_str = decode_fn(src_str)
            # print("src_str:",src_str)
            # print("tgt_str:",target_str)
            # exit()
            if has_target:
